      ...
      <Col>
        <Link to='/'>
          <Logo xmlns="http://www.w3.org/2000/svg" width="1024" height="276.742" viewBox="0 0 1024 276.742"
            ...
            >
            <motion.path
            fill={hovered ? "rgba(229, 16, 19, 0)" : "rgb(229, 16, 19)"}
            stroke="rgb(229, 16, 19)"
            strokeWidth="10"
            initial={{ strokeOpacity: 1 }}
            animate={{ pathLength: hovered ? 1 : 0 , strokeOpacity: hovered ? 1 : 0}}
            transition={{ pathLength: { duration: hovered ? 4 : 0 }, strokeOpacity: { duration: 0 }}}
